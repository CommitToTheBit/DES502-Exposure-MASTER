...
void ADES_L_System::InitializeTree(float Seed, float Rotation, FVector2D Anchoring)
{
	...
	for (FDES_L_Module L_Module : Sentence)
	{
		...
		else if (L_Module.Letter != "]")
		{
			...
			SeedVertices[ChildIndex].Position = FVector(0.0f, 0.0f, 0.0f); 
			SeedVertices[ChildIndex].Transform.TransformVector(SeedVertices[ChildIndex].Position);
...
void ADES_L_System::UpdateTree(float DeltaTime, float DeltaIntensity)
{
	...
	TreeVertices[0].Position = FVector(0.0f, 0.0f, 0.0f);
	TreeVertices[0].Transform.TransformVector(TreeVertices[0].Position);
	...
	for (FDES_L_Module L_Module : Sentence)
	{
		...
		else if (L_Module.Letter != "]")
		{
			...
			TreeVertices[ChildIndex].Position = FVector(0.0f, 0.0f, 0.0f);
			TreeVertices[ChildIndex].Transform.TransformVector(TreeVertices[ChildIndex].Position);
